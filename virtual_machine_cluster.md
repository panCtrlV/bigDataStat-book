...
Since our VM is not empty, it cannot be booted from a normal hard drive. Instead, we need to instruct it to boot from the downloaded ISO file. To accomplish this, go to 
