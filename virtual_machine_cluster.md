...
**Step 9** Select pre-installed softwares. By default, only the core of the OS is installed. We choose to install **OpenSSH server** and **LAMP server**. In order to make the selection, use up and daown arrows for nevigation and hit Space to select.
